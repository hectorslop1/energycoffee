...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  void _validateCashAmount(String value, double total) {
    setState(() {
      ...
      if (cashAmount == null) {
        _cashAmountError = AppLocalizations.of(context).enterValidAmount;
        return;
      }

      if (cashAmount <= 0) {
        _cashAmountError =
            AppLocalizations.of(context).amountMustBeGreaterThanZero;
        return;
      }

      if (cashAmount < total) {
        _cashAmountError = AppLocalizations.of(context).amountInsufficient;
        return;
      }
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                '${cart.itemCount} ${cart.itemCount == 1 ? AppLocalizations.of(context).productLabel : AppLocalizations.of(context).productsLabel}',
                style: TextStyle(
                  fontSize: 14,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildTipModeButton(
                  'amount', AppLocalizations.of(context).amountLabel),
              const SizedBox(width: 8),
              _buildTipModeButton(
                  'percent', AppLocalizations.of(context).percentageLabel),
              const SizedBox(width: 8),
              _buildTipModeButton(
                  'none', AppLocalizations.of(context).noTipOption),
            ],
          ),
          if (_tipMode == 'amount') ...[
            const SizedBox(height: 16),
        ...
        child: Column(
          ...
          children: [
            ...
            if (isSelected) ...[
              const SizedBox(height: 16),
              Text(
                AppLocalizations.of(context).howMuchCashWillYouGive,
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w500,
                  color: AppColors.getTextSecondary(context),
                ...
                Consumer<CartProvider>(builder: (context, cart, child) {
                  ...
                  return Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          AppLocalizations.of(context).yourChangeWillBe,
                          style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w600,
                            color: AppColors.getTextPrimary(context),
              ...
              GestureDetector(
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content:
                          Text(AppLocalizations.of(context).addNewCardSoon),
                      backgroundColor: AppColors.primary,
                    ),
                  );
                },
      ...
      child: Column(
        children: [
          ...
          if (tipAmount > 0) ...[
            ...
            _buildPriceRow(
              _tipMode == 'percent'
                  ? '${AppLocalizations.of(context).tipLabel} (${(_tipPercentage * 100).toStringAsFixed(0)}%)'
                  : AppLocalizations.of(context).tipLabel,
              tipAmount,
              false,
            ),
          ...
          child: ElevatedButton(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 12),
                Text(
                  '${AppLocalizations.of(context).confirmOrder} - \$${total.toStringAsFixed(2)}',
                  style: const TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                  ),
  ...
  void _confirmOrder(BuildContext context, CartProvider cart, double total) {
    ...
    final order = OrderModel(
      ...
      tip: tipAmount,
      total: total,
      paymentMethod: _getPaymentMethodName(context),
      isPaid: _paymentMethod == 'card',
  ...
  String _getPaymentMethodName(BuildContext context) {
    switch (_paymentMethod) {
      case 'cash':
        return AppLocalizations.of(context).cashLabel;
      case 'card':
        return AppLocalizations.of(context).cardLabel;
      case 'terminal':
        return 'Terminal';
      default:
        return AppLocalizations.of(context).cashLabel;
