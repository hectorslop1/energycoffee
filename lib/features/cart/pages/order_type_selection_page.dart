  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          AppLocalizations.of(context).whereWillYouConsume,
          style: TextStyle(
            color: AppColors.getTextPrimary(context),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                AppLocalizations.of(context).selectHowToEnjoyOrder,
                style: TextStyle(
                  fontSize: 15,
              ...
              _OrderTypeCard(
                ...
                title: AppLocalizations.of(context).dineIn,
                description: AppLocalizations.of(context).dineInDescription,
                gradient: isDark
              ...
              _OrderTypeCard(
                ...
                title: AppLocalizations.of(context).takeout,
                description: AppLocalizations.of(context).takeoutDescription,
                gradient: isDark
                    ? AppColors.darkCardGradient
                    : AppColors.lightCardGradient,
                isDark: isDark,
